...
import ru.inversion.edo.xxl.xxi.command.mi_0007.MI_0007_Repository;
...
@Component
public class MI_0003_Handler extends XxiCommandHandler {

   /** */
   private static final int WSP_ID = 3;
    ...
    * @param miPublisher
    */
   public MI_0003_Handler(ReqRepository reqRepository, MiPublisher miPublisher, IMIScriptExecutor scriptExecutor, MI_0003_Repository itmRepository) {
