...
@Getter
public final class XXLException extends RuntimeException
{
   @Serial
   ...
   public enum Namespace
   {
      ...
      MI_INTERNAL_VALIDATION(
              Layer.MI_INTERNAL,
              Subject.VALIDATION
      ),

      /**
       * Business flow, где инициатор MI/S,
       * а XXL ходит в XXI.
       */
      MI_BUSINESS_REQUEST(
              Layer.MI_BUSINESS,
   ...
   private final Errors.LogPolicy logPolicy;
